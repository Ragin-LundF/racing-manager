...
class QualificationRepository {
    ...
    fun findByEventId(eventId: UUID): QualificationEntity? = transaction {
    ...
    fun findById(id: UUID): QualificationEntity? = transaction {
        QualificationTable.selectAll()
    ...
    fun insert(qualification: QualificationEntity) = transaction {
    ...
    fun updateStatus(id: UUID, status: QualificationStatus, updatedAt: kotlin.time.Instant, finalizedAt: kotlin.time.Instant? = null, finalizedBy: UUID? = null) = transaction {
    ...
    private fun mapRow(row: ResultRow): QualificationEntity = QualificationEntity(
